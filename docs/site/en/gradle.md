...
plugins {
	application
	id("io.jimble.jte") version "0.2.0"   // if you use src/main/jte
	id("io.jimble.run") version "0.2.0"   // if you want hot reload
	id("io.jimble.db")  version "0.2.0"   // if you use a database
}
...
> but 'io.jimble:jimble-web:0.2.0' is only compatible with JVM runtime version 25 or newer
> ```
