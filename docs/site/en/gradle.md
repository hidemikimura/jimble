...
plugins {
	application
	id("io.jimble.jte") version "1.2.1"
	id("io.jimble.run") version "1.2.1"
	id("io.jimble.db")  version "1.2.1"
}
```
...
plugins {
	application
	id("io.jimble.jte") version "1.2.1"   // if you use src/main/jte
	id("io.jimble.run") version "1.2.1"   // if you want hot reload
	id("io.jimble.db")  version "1.2.1"   // if you use a database
}
...
dependencies {
	implementation("io.jimble:jimble-web:1.2.1")
...
> but 'io.jimble:jimble-web:1.2.1' is only compatible with JVM runtime version 25 or newer
> ```
