...
plugins {
	application
	id("io.jimble.jte") version "1.2.0"
	id("io.jimble.run") version "1.2.0"
	id("io.jimble.db")  version "1.2.0"
}
```
...
plugins {
	application
	id("io.jimble.jte") version "1.2.0"   // if you use src/main/jte
	id("io.jimble.run") version "1.2.0"   // if you want hot reload
	id("io.jimble.db")  version "1.2.0"   // if you use a database
}
...
dependencies {
	implementation("io.jimble:jimble-web:1.2.0")
...
> but 'io.jimble:jimble-web:1.2.0' is only compatible with JVM runtime version 25 or newer
> ```
