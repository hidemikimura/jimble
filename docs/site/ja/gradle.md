---
title: Gradle プラグイン
summary: io.jimble.db / jte / run のタスクと設定
section: 開発
order: 2
---
...
plugins {
	application
	id("io.jimble.jte") version "0.5.0"   // src/main/jte を使うなら
	id("io.jimble.run") version "0.5.0"   // ホットリロードを使うなら
	id("io.jimble.db")  version "0.5.0"   // DB を使うなら
}
