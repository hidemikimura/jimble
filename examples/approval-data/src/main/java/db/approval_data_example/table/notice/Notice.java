...
public class Notice extends Table {
	...
	/* このテーブルの実体（1つだけ作る） */
	private static final Notice INSTANCE = new Notice(new ApprovalDataExample(), "notice");
	...
	private static final List<Column> COLUMNS = List.of(id, request_id, to_staff_id, kind, created_at);
