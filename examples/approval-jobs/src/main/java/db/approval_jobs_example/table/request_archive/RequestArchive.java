...
public class RequestArchive extends Table {
	...
	/* このテーブルの実体（1つだけ作る） */
	private static final RequestArchive INSTANCE = new RequestArchive(new ApprovalJobsExample(), "request_archive");
	...
	public static RequestArchive instance () { return INSTANCE; }
