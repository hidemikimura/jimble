...
**0.3.0 を Maven Central に公開している。ドキュメントは <https://jimble.io>。**
...
**0.3.0 を Maven Central に公開済み。ドキュメントは <https://jimble.io> で公開済み。**
...
- `-Pjimble.version` を渡さないと `0.5.1-SNAPSHOT`（次の版のスナップショット）になり、`centralUpload` は止まる
